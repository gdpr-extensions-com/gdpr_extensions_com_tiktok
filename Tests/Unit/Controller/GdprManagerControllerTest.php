...
namespace GdprExtensionsCom\GdprExtensionsComTiktok\Tests\Unit\Controller;
...
{
    /**
     * @var \GdprExtensionsCom\GdprExtensionsComTiktok\Controller\GdprManagerController|MockObject|AccessibleObjectInterface
     */
    protected $subject;
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder($this->buildAccessibleProxy(\GdprExtensionsCom\GdprExtensionsComTiktok\Controller\GdprManagerController::class))
    ...
    public function listActionFetchesAllGdprManagersFromRepositoryAndAssignsThemToView(): void
    {
        ...
        $gdprManagerRepository = $this->getMockBuilder(\GdprExtensionsCom\GdprExtensionsComTiktok\Domain\Repository\GdprManagerRepository::class)
            ->onlyMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $gdprManager = new \GdprExtensionsCom\GdprExtensionsComTiktok\Domain\Model\GdprManager();
